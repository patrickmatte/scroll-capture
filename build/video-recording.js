...
var backButton = document.querySelector(".sc-trash-button");
...
if (page.videoURL) {
  ...
  var dateData = {
    year: video_recording_date.getFullYear(),
    month: Object(number["a" /* addLeadingZero */])(video_recording_date.getMonth() + 1),
    date: Object(number["a" /* addLeadingZero */])(video_recording_date.getDate())
  };
