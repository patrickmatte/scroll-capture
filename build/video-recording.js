...
function updateVideo(message) {
  ...
  for (let i = 0; i < buttons.length; i++) {
    ...
    button.addEventListener('click', () => {
      (0,_model_GABridge__WEBPACK_IMPORTED_MODULE_0__.sendTrackEventMessage)('download', 'video');
    });
  }
